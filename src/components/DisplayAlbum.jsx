    ...
    <>
       ...
       <hr/>
       {
        songsData.map((item,index)=>(
          <div onClick={()=>playWithId(item.id)} key={index} className='grid grid-cols-3 sm:grid-cols-4 gap-2 p-2 py-4 items-center text-[#a7a7a7] hover:bg-[#353232] cursor-pointer'>
              ...
              <p className='text-[12px] text-center hidden sm:block'>{item.duration}</p>
          </div>
        ))
       }
    </>
